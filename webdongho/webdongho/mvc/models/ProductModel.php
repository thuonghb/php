...
class productModel
{
    ...
    {
        $db = DB::getInstance();
        $sql = "SELECT p.id, p.name, p.image, p.originalPrice, p.promotionPrice, p.qty as qty, p.soldCount as soldCount FROM products p JOIN categories c ON p.cateId = c.id WHERE MATCH(p.name) AGAINST ('$keyword') AND p.status=1";
    ...
    {
        $db = DB::getInstance();
        $sql = "SELECT p.id, p.name, p.image, p.originalPrice, p.promotionPrice, p.qty as qty, p.soldCount as soldCount FROM products p JOIN categories c ON p.cateId = c.id WHERE MATCH(p.name) AGAINST ('$keyword') AND p.status=1 AND p.id != $id LIMIT 4";
        $result = mysqli_query($db->con, $sql);
        return $result;
    }
    ...
    public function insert($product)
    {
        ...
        $uploaded_image = APP_ROOT . "../../public/images/product/" . $unique_image;
        ...
        $uploaded_image2 = APP_ROOT . "../../public/images/product/" . $unique_image2;
        ...
        $uploaded_image3 = APP_ROOT . "../../public/images/product/" . $unique_image3;
