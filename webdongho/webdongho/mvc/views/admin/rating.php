                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php
                                            if ($value['reply']) { ?>
                                                <a class="button-normal" href="<?= URL_ROOT . '/ratingManage/reply/' . $value['id'] ?>"><i class="fa fa-list" aria-hidden="true"></i> / <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                <a class="button-red" href="<?= URL_ROOT . '/ratingManage/delete/' . $value['id'] ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            <?php } else { ?>
