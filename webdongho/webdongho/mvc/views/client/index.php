...
<body>
  ...
  <div class="slideshow-container">
    ...
    <div class="mySlides fade">
      ...
      <img src="<?= URL_ROOT ?>/public/images/banner/banner.jpg" style="width:100%;">
    </div>
          
    <div class="mySlides fade">
      <div class="numbertext">2 / 3</div>
      <img src="<?= URL_ROOT ?>/public/images/banner/banner1.jpg" style="width:100%;">
    </div>
          
    <div class="mySlides fade">
      <div class="numbertext">3 / 3</div>
      <img src="<?= URL_ROOT ?>/public/images/banner/banner2.jpg" style="width:100%;">
    </div>
